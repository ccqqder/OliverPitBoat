...
J: Tes awal adalah penilaian cepat berbasis kosakata dan mungkin tidak sepenuhnya mencerminkan level Anda yang sesungguhnya. Anda bisa menyesuaikan level secara manual dari layar utama, atau mengikuti tes ulang. Setelah menggunakan aplikasi beberapa saat, aplikasi akan menyesuaikan diri secara otomatis berdasarkan riwayat jawaban Anda.

**T: Model apa yang dibutuhkan fitur percakapan AI? Seberapa besar ukurannya?**  
J: Berdasarkan performa perangkat Anda, aplikasi merekomendasikan model yang sesuai (Llama 3.2 atau Qwen 2.5). Ukuran model bervariasi — dari beberapa ratus megabyte hingga beberapa gigabyte, tergantung modelnya. Setelah diunduh, percakapan berjalan **sepenuhnya offline** — tidak memerlukan koneksi internet.
...
J: Artikel dibuat berdasarkan level CEFR Anda. Jika terasa terlalu sulit, turunkan level Anda dari layar utama, atau pilih tingkat kesulitan yang lebih rendah secara manual saat membuat artikel.
...
1. **Model AI gagal dimuat**: Pastikan ruang penyimpanan kosong cukup untuk model yang Anda pilih, dan periksa apakah unduhan tidak terputus

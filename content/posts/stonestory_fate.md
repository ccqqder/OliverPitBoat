...
王國維及胡適等為紅學的先驅，紅學持續發展一直到近年，搭配最新技術的研究成果，

在於機器學習再次證明後四十回不是原作者所著，以及使用LLM建立知識圖譜Domain-specific Graph ，以及對文字做更細緻的語意向量化Word Embedding 等...

LLM跟此任務相關的特性是，它是現有網路上所有資料，以及這些前沿AI實驗室所能夠得到的所有有價值的材料，所訓練出來的。

對於既有的資訊它預測能力跟傾向很高，比如你輸入哈利波特書中的一個片段，它可以背誦出後面的段落。

但是紅樓夢，如果我們假設它的結局存在，並且前八十回跟結局是有機、有意識的連續寫作
